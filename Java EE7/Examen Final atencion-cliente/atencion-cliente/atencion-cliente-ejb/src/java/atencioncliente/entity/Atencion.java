 ...
 */
package atencioncliente.entity;
...
@NamedQueries({
    ...
    @NamedQuery(name = "Atencion.findMaxNroAtencion", query = "SELECT MAX(a.nroAtencion) FROM Atencion a"),
    @NamedQuery(name = "Atencion.findByClienteAndMod", query = "SELECT a FROM Atencion a WHERE a.rut.rut=:rutCliente AND a.idServicio.idServicio=:idServicio")
...
public class Atencion implements Serializable {
    ...
    public Atencion(Integer nroAtencion, boolean esCliente, int tiempoEspera, Date fechaCreacion) {
        this.nroAtencion = nroAtencion;
    ...
    public String toString() {
        return "atencioncliente.entity.Atencion[ nroAtencion=" + nroAtencion + " ]";
    }
