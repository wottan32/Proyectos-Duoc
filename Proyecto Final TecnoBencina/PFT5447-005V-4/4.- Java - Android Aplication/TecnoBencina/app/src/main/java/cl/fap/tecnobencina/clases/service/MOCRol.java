...
public class MOCRol extends AttributeContainer implements KvmSerializable
{
    ...
    public MOCArrayOfPermiso permisos;

    public MOCRol ()
    {
    }

    public MOCRol (java.lang.Object paramObj,MOCExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (info.name.equals("permisos"))
                {
                    if(obj!=null)
                    {
                        java.lang.Object j = obj;
                        this.permisos = new MOCArrayOfPermiso(j,__envelope);
                    }
                    continue;
                }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==2)
        {
            return this.permisos!=null?this.permisos:SoapPrimitive.NullSkip;
        }
        return null;
    }
